...
def main():
    ...
    parser.add_argument('--base_model_name_or_path', default='/path/to/base_model', type=str,
                        help="Base model name or path")
    parser.add_argument('--peft_model_path', default='/path/to/peft_model', type=str,
